...
const StudentLayout = () => {
  ...
  const menuItems = [
    { path: '/student/dashboard', icon: HiOutlineHome, label: 'Dashboard' },
    { path: '/student/courses', icon: HiOutlineBookOpen, label: 'My Courses' },
    { path: '/student/grades', icon: HiOutlineDocumentText, label: 'Grades' },
    { path: '/student/attendance', icon: HiOutlineClipboardCheck, label: 'Attendance' },
    { path: '/student/schedule', icon: HiOutlineCalendar, label: 'Schedule' },
    { path: '/student/fees', icon: HiOutlineCreditCard, label: 'Fees' },
    { path: '/student/profile', icon: HiOutlineUser, label: 'Profile' },
    { path: '/student/ai-assistant', icon: HiOutlineSparkles, label: 'AI Assistant' },
  ];
            ...
            <AnimatePresence mode="wait">
              {sidebarOpen && (
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{user?.studentId}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
