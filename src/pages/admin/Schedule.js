...
const Schedule = () => {
  const schedule = [
    ...
    { day: 'Tuesday', slots: [
      ...
      { time: '11:00 AM', subject: 'Web Development', room: 'CS-102', teacher: 'Prof. Neha Gupta' },
    ]},
    { day: 'Wednesday', slots: [
      { time: '10:00 AM', subject: 'Computer Networks', room: 'CS-104', teacher: 'Dr. Priya Patel' },
      { time: '2:00 PM', subject: 'Operating Systems', room: 'CS-101', teacher: 'Dr. Anil Verma' },
    ]},
    { day: 'Thursday', slots: [
      { time: '9:00 AM', subject: 'Data Structures Lab', room: 'Lab-1', teacher: 'Dr. Rajesh Kumar' },
      { time: '2:00 PM', subject: 'Algorithms', room: 'CS-102', teacher: 'Dr. Rajesh Kumar' },
    ]},
    { day: 'Friday', slots: [
      { time: '10:00 AM', subject: 'Machine Learning', room: 'CS-201', teacher: 'Dr. Vijay Singh' },
      { time: '1:00 PM', subject: 'Project Discussion', room: 'Meeting Room', teacher: 'All Faculty' },
    ]},
  ];
              ...
              {day.slots.map((slot, idx) => (
                <div key={idx} className="flex items-center gap-4 p-3 rounded-xl bg-gray-50 dark:bg-dark-200">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{slot.teacher}</p>
                  </div>
